...
const Movie = ({movie}) => {
  ...
  return (
    <div className=''>
        <div className='movie h-[200px] w-[200px] md:w-[300px] md:h-[300px] bg-[#000000] p-[10px] rounded-[12px] relative'>
          <img src={movie.Poster == 'N/A' ? defaultPoster :  movie.Poster} className='movie-cover w-full h-full object-cover'/>
